# -*- coding: utf-8 -*-
"""
Created on Tue Mar  8 19:15:41 2022
...
if not os.path.exists("ucus_noktaları.xlsx"):
    all_city_codes = []
    ...
    url = "https://www.obilet.com/ucus-noktalari"    
    browser.get(url)    
    ...
    for destination_url in all_destinations_urls:
        ...
        time.sleep(1)
        city_code=browser.find_element_by_xpath("/html/body/main/div[1]/div[2]/form/div[1]/div[2]/div/ob-select/div/ul/li").get_attribute('data-value')                                       
    ...
    df.to_excel("ucus_noktaları.xlsx")
